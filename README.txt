...
(3) hit enter to move onto the next panel and run the code
as the code will show you some important consequences or
show pretty pictures or some algorithmic interpretations
of what is going on in the text

(4) pay attention in class. this is mostly to aid in the
material and give you a better intuition as you engage it.

(5) recognize that the ordering I chose was on purpose, and
it doesn't necessarily fit the book's ordering nor is it
a guarantee that it will reflect the professor's ordering.
that's fine as multiple viewpoints should help a lot!
